...
- [Quarto publishing system][Q]: **Only for non-Rstudio users** (Quarto is
already bundled with Rstudio) this additional component is necessary to
...
|    |
|    |--- agendas (To store meeting agendas)
|    |
